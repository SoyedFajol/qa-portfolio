...
export const PROFILE = {
  ...
  headline: 'Software Engineer · SQA · AI Engineer · Gamer · Sportsperson',
  title: 'Junior SQA Engineer @ BRAC IT Services Ltd. · Builder of fun things',
  hometown: 'Chapainawabganj, Bangladesh',
  ...
  schooling: [
    {
      ...
      note: 'Primary schooling in Chapainawabganj — GPA 5 and a General Grade Scholarship.',
    },
    {
      school: 'Harimohan Government High School',
      note: 'Won a seat standing 21st among thousands in the admission exam.',
    },
  ],
  ...
  experience: [
    ...
    },
    {
      ...
      company: 'Lawcosmos AI',
      period: 'Feb 2024 – Feb 2025 · 1 year · unpaid, for work-culture experience',
      bullets: [
        'Led team meetings and coordinated team leads, frontend and backend engineers for seamless integration',
        'Managed project timelines and oversaw final stages to launch a fully functional product',
        'Conducted research to inform product development and wrote comprehensive product documentation',
      ],
    },
    {
      role: 'Campus Ambassador (Volunteer)',
      company: 'Locus & Creative Wings',
      period: 'Mar 2024 – Dec 2024 · 10 months · unpaid, for work-culture experience',
      bullets: [
        'Built a strong bridge between the university and the company for communication and collaboration',
        'Organized and coordinated events and workshops, growing the company’s visibility on campus',
        'Acted as liaison between students and the company, promoting initiatives and answering queries',
      ],
    },
  ],
  ...
  extras: [
    ...
    'AIUB Competitive Programming Club member — offline & online problem-solving contests',
    'Campus Ambassador at Locus and Creative Wings — organized events, workshops and campus programs',
    'Volunteered teaching kids about software and coding',
  ],

  sports: [
    '🏏 U-14 national cricket team captain',
    '⚽ Semi-professional cricket & football player',
    '🏃 Marathon runner & multi-sport athlete',
  ],
  ...
  skills: {
    ...
    backend: ['Spring Boot', 'NestJS', 'Django', 'FastAPI', 'Microservices'],
    alsoCode: ['C', 'C#', 'PHP', 'Dart', 'Flutter'],
    databases: ['MySQL', 'SQL', 'PostgreSQL'],
    tools: ['Jira', 'Postman', 'Swagger', 'Git', 'GitHub', 'Notion', 'MS Office', 'Claude Code'],
    aiStack: ['Claude Code', 'Gemini API', 'GPT-4 integration', 'AI-assisted QA'],
    apis: ['RESTful API', 'Third-party API integration'],
    languages: ['Bangla (Fluent)', 'English (Fluent)'],
    secretClass: ['Spring Boot', 'NestJS', 'Django', 'Microservices'],
  },

  story: [
    { icon: '🏡', title: 'Chapainawabganj', desc: 'Born and brought up in the mango city — where the story begins.' },
    { icon: '🏫', title: 'Green View High School', desc: 'Primary years: GPA 5 and a General Grade Scholarship.' },
    { icon: '🎖️', title: 'Harimohan Govt. High School', desc: 'Stood 21st among thousands in admission to the historic school.' },
    { icon: '🎓', title: 'AIUB CSE student', desc: 'Moves to Dhaka, discovers coding at American International University-Bangladesh.' },
